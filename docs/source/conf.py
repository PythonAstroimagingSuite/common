...
htmlhelp_basename = 'PythonAstroimagingSuitedoc'
...
latex_documents = [
    (master_doc, 'PythonAstroimagingSuite.tex', 'PythonAstroimagingSuite Documentation',
...
man_pages = [
    (master_doc, 'PythonAstroimagingSuite', 'PythonAstroimagingSuite Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PythonAstroimagingSuite', 'PythonAstroimagingSuite Documentation',
     author, 'PythonAstroimagingSuite', 'One line description of project.',
     'Miscellaneous'),
]
